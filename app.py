...
if selected == 'About Me':
    ...
    st.write("---")
    st.image(img_info3)
    st.write("[Learn more about me & my other projects](https://github.com/gozdemadendere)")
...
if selected == 'Contact':
    ...
    with st.container():
        ...
        with right_column:
            ...
            st.write("[My Portfolio Projects](https://github.com/gozdemadendere) | [LinkedIn](https://www.linkedin.com/in/gozdemadendere/) | [Github](https://github.com/gozdemadendere) | [Tableau](https://public.tableau.com/app/profile/gozdemadendere/vizzes) | [Medium](https://medium.com/@gozdemadendere)")
